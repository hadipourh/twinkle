            ...
            for y in range(4):
                for x in range(4):
                    for z in range(80):
                        row = x + 4*y
                        column = z
                        selected_color = self.color_map[self.upper_trail["x"][self.RU + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_x.append(r"""\TFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
                        selected_color = self.color_map[self.lower_trail["x"][r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_x.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
                        selected_color = self.color_map[self.upper_trail["x"][self.RU + r + 1][x][y][z]]
                        if selected_color != "white":
                            fillcolor_x_next.append(r"""\TFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
            ...
            for x in range(4):
                for y in range(4):
                    for z in range(80):
                        row = x + 4*y
                        column = z
                        selected_color = self.color_map[self.upper_trail["y"][self.RU + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_y.append(r"""\TFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
                        selected_color = self.color_map[self.upper_trail["z"][self.RU + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_z.append(r"""\TFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")                            
                        selected_color = self.color_map[self.upper_trail["w"][self.RU + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_w.append(r"""\TFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")                            
            ...
            for y in range(4):
                for x in range(4):
                    for z in range(80):
                        row = x + 4*y
                        column = z
                        selected_color = self.color_map[self.lower_trail["x"][self.RM + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_x.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
                        selected_color = self.color_map[self.lower_trail["x"][self.RM + r + 1][x][y][z]]
                        if selected_color != "white":
                            fillcolor_x_next.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
            fillcolor_x = ",".join(fillcolor_x)
            fillcolor_x_next = ",".join(fillcolor_x_next)
            ...
            for x in range(4):
                for y in range(4):
                    for z in range(80):
                        row = x + 4*y
                        column = z                           
                        selected_color = self.color_map[self.lower_trail["y"][self.RM + r][x][y][z]] 
                        if selected_color != "white":
                            fillcolor_y.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")                            
                        selected_color = self.color_map[self.lower_trail["z"][self.RM + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_z.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")
                        selected_color = self.color_map[self.lower_trail["w"][self.RM + r][x][y][z]]
                        if selected_color != "white":
                            fillcolor_w.append(r"""\BFillCell""" + f"[{selected_color}]" + f"{{{row}}}{{{column}}}\n")                            
            fillcolor_y = ",".join(fillcolor_y)
            fillcolor_z = ",".join(fillcolor_z)
